...
const planets = document.querySelectorAll(".nav-links li a");
const buttons = document.querySelectorAll(".btn");
var planetSummaryText = document.getElementById("planet-summary");
var planetName = document.getElementById("planet-name");
var planetImage = document.getElementById("planet");
var rotationTime = document.querySelector(".rotation h2");
var revolution = document.querySelector(".revolution h2");
var radius = document.querySelector(".radius h2");
var temperature = document.querySelector(".temperature h2");
var overviewButton = document.getElementsByClassName("btn overview")[0];
var colorEarth = "#6F2ED6";
var colorMercury = "#419EBB";
var colorVenus = "#EDA249";
var colorMars = "#D14C32";
var colorJupiter = "#D83A34";
var colorSaturn = "#CD5120";
var colorUranus = "#1EC2A4";
var colorNeptune = "#2D68F0";

console.log(buttons);
var selectedPlanet = function () {
  var name = this.innerHTML;
  for (let i = 0; i < planetData.length; i++) {
    if (name == planetData[i].name) {
      planetName.innerHTML = planetData[i].name;
      planetImage.src = planetData[i].images.planet;
      rotationTime.innerHTML = planetData[i].rotation;
      revolution.innerHTML = planetData[i].revolution;
      radius.innerHTML = planetData[i].radius;
      temperature.innerHTML = planetData[i].temperature;
      planetSummaryText.innerHTML = planetData[i].overview.content;

      switch (name) {
        case "Mercury":
          overviewButton.style.backgroundColor = colorMercury;
          break;
        case "Venus":
          overviewButton.style.backgroundColor = colorVenus;
          break;
        case "Earth":
          overviewButton.style.backgroundColor = colorEarth;
          break;
        case "Mars":
          overviewButton.style.backgroundColor = colorMars;
          break;
        case "Jupiter":
          overviewButton.style.backgroundColor = colorJupiter;
          break;
        case "Saturn":
          overviewButton.style.backgroundColor = colorSaturn;
          break;
        case "Uranus":
          overviewButton.style.backgroundColor = colorUranus;
          break;
        case "Neptune":
          overviewButton.style.backgroundColor = colorNeptune;
          break;
      }
    }
  }
...
for (let i = 0; i < planets.length; i++) {
  planets[i].addEventListener("click", selectedPlanet);
}

for (let i = 0; i < buttons.length; i++) {
  buttons[i].addEventListener("click", changeDisplay);
}
